...
", "action": "Move Forward 2 Spaces", "move": 2},
	...
	"Spot20": {"title": "They CANNOT Break Us: Checkpoint 4", "At this moment, Equality is imprisoned and taken to the Palace of Corrective Detention because he refuses to talk about why he wasn’t in the theater. Once he got there, he was lashed and beaten until, “we could not move our body. Then we smiled, for we thought of the light and that we had not betrayed it,”(Rand 66). Rand criticizes the use of fear and punishment to force obedience. Beating Equality suppresses his independent thoughts and individuality, but he endures it to protect the light he created. This promotes the belief that strength comes from individuality. Although Equality was barely able to move due to the pain from the lashing, he continued to refuse to reveal his secret. He is a symbol of this belief because he was proud of the light that he made by himself, and he wouldn’t let his discovery be destroyed. To protect his individual discovery, he withstood days of lashing and beating. The only reason that he was able to maintain his strength throughout his stay in the Palace of Corrective Detention was because the thought of the lightbulb motivated him and reminded him of his priorities.
": "Response", "action": "No Action", "move": 0},
